import { isValidString } from './jsonUtils.ts';
import { applyWebhookEvent, logWebhookSecurityEvent, verifyWebhookRequest } from './webhookProcessor.ts';
...
export async function handleVeriffWebhook(request: Request): Promise<Response> {
